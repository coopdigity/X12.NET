    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            using (var fs = new FileStream(inputFilename, FileMode.Open, FileAccess.Read))
            {
                ...
                {
                    AuthorInfoQualifier = configurationManager["AuthorInfoQualifier"],
                    AuthorInfo = configurationManager["AuthorInfo"],
                    SecurityInfoQualifier = configurationManager["SecurityInfoQualifier"],
                    SecurityInfo = configurationManager["SecurityInfo"],
                    InterchangeSenderIdQualifier = configurationManager["InterchangeSenderIdQualifier"],
                    InterchangeSenderId = configurationManager["InterchangeSenderId"],
                ...
                group.ApplicationSendersCode = configurationManager["InterchangeSenderId"];
